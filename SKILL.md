...
- **知名人物**：标准 Skill（~3000 tokens），模型自身知识足够补充
- **小众人物**：在 Skill 末尾增加 `## 关键原文档案` section，从 research/ 中精选 8-12 条最有代表性的原文引用（此人亲口说的话、写的文字），确保模型即使不认识此人也能准确模拟。Skill 膨胀到 ~6000-8000 tokens，但对小众人物这是必要的。
